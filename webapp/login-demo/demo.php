...
<div id="toppanel">
	...
	<div class="tab">
		<ul class="login">
	    	<li class="left">&nbsp;</li>
	        <li>Hello <?php if(isset($_SESSION['usr']) && isset($_SESSION['usr']) ) echo $_SESSION['usr'] ? $_SESSION['usr'] : 'Guest';?>!</li>
			<li class="sep">|</li>
			<li id="toggle">
				<a id="open" class="open" href="#"><?php if(isset($_SESSION['id']))  echo $_SESSION['id']?'Open Panel':'Log In | Register';?></a>
